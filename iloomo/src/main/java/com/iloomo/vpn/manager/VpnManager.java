package com.iloomo.vpn.manager;

import android.text.TextUtils;

import com.iloomo.utils.L;
import com.iloomo.vpn.util.RunCommand;
...
public class VpnManager
{
	...
	public static boolean startVpn(VpnProfile p) {
		...
		String[] args = new String[]{iface, "pptp", p.server, "1723", "name", p.username,
					...
					"idle", "1800", "mtu", "1436", "mru", "1400", (p.mppe ? "+mppe" : "nomppe"),
					"unit", PPP_UNIT};
	...
	private static void startMtpd(String[] args) {
		...
		try {
			L.e("   " + s.toString());
//			String  sb="mtpd wlan0 pptp 178.79.191.217 1723 linkname vpn mppe usepeerdns lcp-echo-failure 20 lcp-echo-interval 4 mtu 1396 mru 1396 unit 100 nodetach user wupeitao password wupeitao12 ipparam vpn  &";
